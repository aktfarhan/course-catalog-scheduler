...
exports.scrapeInstructorInfo = scrapeInstructorInfo;
 ...
 */
async function scrapeInstructorInfo() {
 ...
 */
async function extractStaffFromPage(page, instructorMap) {
    ...
    for (let i = 0; i < count; i++) {
        ...
        const name = (0, utils_1.removeAccents)((await card.locator('a > span.button-cta.card-heading-name').textContent())?.trim() ??
            '');
