            ...
            <div className="group relative w-full">
                ...
                {searchQuery ? (
                    <button
                        ...
                        className="absolute top-1/2 right-5 -translate-y-1/2 cursor-pointer rounded-lg bg-gray-100 p-1.5 text-gray-400 transition-all hover:bg-gray-200 hover:text-gray-600 active:scale-90"
                    >
