    ...
    const getTabStyles = (tab: 'catalog' | 'calendar') => {
        ...
        return clsx(
            ...
            isActive
                ...
                : 'text-slate-400 hover:text-slate-600 hover:bg-gray-100/70 border-transparent bg-transparent',
        );
    };
    return (
        <nav
            className="w-full border-b border-gray-100 bg-gray-50 px-4 pt-6 sm:px-10"
            role="tablist"
        >
